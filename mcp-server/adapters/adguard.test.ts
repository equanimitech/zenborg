...
describe("collectResolverHosts", () => {
  ...
  it("collects hosts from resolver-enforced cooldowns", () => {
    const fences = {
  ...
  it("ignores browser-enforced cooldowns", () => {
    const fences = {
  ...
  it("ignores cooldowns with no enforcement (defaults to browser)", () => {
    const fences = {
  ...
  it("ignores non-browser-scoped rules", () => {
    const fences = {
      r1: {
        ...makeRule("chess.com", { at: "resolver", profile: "default" }),
